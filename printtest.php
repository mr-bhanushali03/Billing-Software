...
<body>
<table style="page-break-before: always;" align="center">
<tbody>
<tr>
<td colspan="" align="center" height="10" style="border-bottom: thin double  #fff; border-top: thin double  #fff;border-left: thin double #fff ;border-right: thin double #fff;><span style="font-size: small;"><strong><u>TAX INVOICE CUM CHALLAN&nbsp;</u></strong></span></td>
</tr>
</tbody>
</table>

<table class="main_table" cellpadding=4 cellspacing=4 height="297mm" style="width:208mm" border="" align="center">
<thead>
<tr>
...
<td style="width: 388px; border-left: thin double #fff;" colspan="" align="center"><Font size="2">Details of Reciver / Bill to:</font></td>
<td style="width: 380px; border-right: thin double #fff;" colspan="" align="center"><Font size="2">Details of Consignee / Shipped to:</font></td>
</tr>
...
<td style="width: 235px;" colspan="" class="a">&nbsp;<?php echo $ss['state']; ?></td>
<td style="width: 61px;" colspan="">State Code</td>
<td style="width: 31px" colspan="" align="center" class="a"><?php echo $ss['state_code']; ?></td>
<td style="width: 49px;" colspan=""align="center">State</td>
<!--<td style="width: 225px; border-bottom: thin double  #fff" colspan="">&nbsp;</td>-->
<td style="width: 225px;" colspan=""; class="a">&nbsp;<?php echo $sss['state']; ?></td>
<td style="width: 61px;" colspan="";align="center">State Code</td>
<td style="width: 27px;" colspan=""; align="center"class="a"><?php echo $sss['state_code']; ?></td>
</tr>
</tbody>
</table>
</td>
...
<?php 
				...
				//$cuid = $cu['sid'];
			 ?>
<td style="width: 10%" colspan="" align="right" class="a">
<?php 
...
<!-- <tfoot>
 ...
 --></table>
<p align="center"><a class="btn btn-danger text-orange" href="invoice_print.php?id=<?php echo $row['quot_id'] ?>" target="_blank"><em class="fa fa-print"> Print</em></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-danger text-orange" href="quot_list.php?id=<?php echo $row['quot_id'] ?>" target="_blank"><em class="fa-back"> Cancel</em></a></p>
