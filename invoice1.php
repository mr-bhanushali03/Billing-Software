...
<div class="row">
  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input type="text" data-error="Enter Invoice Date" required="required" value="<?php echo date('d / M / Y', strtotime($current_date)); ?>" name="inv_date" class="form-control ">
        <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add. CGST @ </label></div>
    <div class="col-sm-1">
		<input type="text" id="cgst" class="form-control " name="cgstper" onkeyup="add_cgst(this.value)" value="0">  			
  ...
  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add.UTGST @ </label></div>
    <div class="col-sm-1" >
		<input type="text" id="sgst" class="form-control " name="sgstper" onkeyup="add_sgst(this.value)" value="0">  		
	</div>
 ...
 <div class="row">
  ...
  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add. IGST @ </label></div>
    <div class="col-sm-1">
		<input type="text" id="igst" class="form-control " name="igstper" onkeyup="add_igst(this.value)" value="0">  
	</div>
