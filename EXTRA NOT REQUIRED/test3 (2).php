...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2"></div>
    ...
    <div class="col-md-7">
    <input type="text" data-error="Enter order No" required="" value="" name="order_no" class="form-control" placeholder="Enter order no">
    <div class="help-block with-errors"></div> 
    </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input type="text" data-error="Enter Invoice Date" required="required" value="<?php echo date('d / M / Y', strtotime($current_date)); ?>" name="inv_date" class="form-control " readonly>
        <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
    <div class="form-group">
      ...
      <div class="col-md-7">
        <input type="date" data-error="Enter Order Date" required="" value="" name="order_date" class="form-control " placeholder=" Enter order date">
        <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-0 p-0">
      <div class="form-group">
			...
			<div class="col-md-8">
					<select name="q_custname" class="form-control select2">
						<option  selected>--CUSTOMER NAME--</option>
							...
							?>
							<option value="<?php echo $row['id']; ?>"><?php echo $row['custname']; ?></option>
							<?php } ?>
					</select>
				<div class="help-block with-errors"></div> 
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
					<input type="text" name="transmode" class="form-control " id="transmode" placeholder="Transportation Mode" >
					<div class="help-block with-errors"></div> 
			</div>
		</div>
      ...
      <div class="form-group">
			...
			<div class="col-md-8">
					<input type="date" name="supplydate" class="form-control " id="supplydate" >
					<div class="help-block with-errors"></div> 
			</div>
      </div>
      ...
      <div class="form-group">
			...
			<div class="col-md-8">
					<input type="text" name="state" placeholder="Enter State" class="form-control " id="state" >
					<div class="help-block with-errors"></div> 
			</div>
      </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="form-group">
			  <label class="col-md-4 control-label">LR NO: </label>
				<div class="col-md-8">
					<input type="text" name="lrno" class="form-control " id="lrno" placeholder="LR NO" >
					<div class="help-block with-errors"></div> 
				</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
					<input name="vehicleno" class="form-control" placeholder="Vehicle Number">
				<div class="help-block with-errors"></div> 
			</div>
		</div>
	<div class="form-group">
			...
			<div class="col-md-8">
					<input type="text" placeholder="Enter State Code" name="statecode" class="form-control " id="statecode" >
					<div class="help-block with-errors"></div> 
			</div>
      </div>
    </div> 
			...
			<table width="100%" style="overflow-x: none !important;">
							...
							<td class="tda col-lg-2 column">
									<select id="item_qty" name="item_qty" class="form-control select2"   >
										<option value="" selected>-Select item-</option>
											<?php 
													$retrive_query=mysqli_query($conn, "select * from product_detail") or die(mysqli_error());
				...
				-->     	</td>
							...
							<td class="tda">
							  ...
							  <!--<input type="text" data-error="Unit" id="unit"  name="unit" class="form-control" placeholder="Unit" onchange="change_tot()"> -->
							</td> 
							...
							<td class="tda">
							  <input type="number" id="discount" name="discount" class="form-control " step="0.01" placeholder="0.00%" onChange="change_tott()" >
							</td>
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Sub Total(Rs.): </label>
      <div class="col-md-7">
      <input type="number" required="required" id="sub_total" name="sub_total" class="form-control " readonly >
      <div class="help-block with-errors" ></div> 
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Packing Charge:</label>
      <div class="col-md-7">
      <input type="text" name="packing" id="packing" class="form-control " onchange="totalAdd(this.value)">
      <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Transportation charge:</label>
      <div class="col-md-7">
      <input type="text" name="frieght" id="frieght" class="form-control " onchange="totalAdd(this.value)">
      <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Net Total(Rs.): </label>
      <div class="col-md-7">
...
<div class="row">
  ...
  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add. CGST @ </label></div>
    <div class="col-sm-1">
		<select id="cgst" class="form-control " name="cgstper" onchange="add_cgst(this.value)">  
			<option selected value="0" >CGST</option>
			<option value="18">18%</option>
			<option value="14">14%</option>
			<option value="12">12%</option>
		</select>
		<input type="hidden" name="addCgstTo" id="addCgstTo">
	</div>
    <div class="col-sm-2" ><input type="text" value="0.00" name="cgst_tot" id="cgst_tot" class=" form-control col-md-3 column" readonly></div>
 </div>
  <div class="row">

  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add. SGST @ </label></div>
    <div class="col-sm-1" >
		<select id="sgst" class="form-control " name="sgstper" onchange="add_sgst(this.value)">  
			<option selected value="0">SGST</option>
			<option value="18">18%</option>
			<option value="14">14%</option>
			<option value="12">12%</option>
		</select>
	</div>
    <div class="col-sm-2" ><input type="text" value="0.00" name="sgst_tot" id="sgst_tot" class=" form-control col-md-3 column" readonly></div>
 </div>
 ...
 <div class="row">
  ...
  <div class="col-sm-8 "></div>
   <div class="col-sm-1 form-group"><label> Add. IGST @ </label></div>
    <div class="col-sm-1">
		<select id="igst" class="form-control " name="igstper" onchange="add_igst(this.value)">  
			<option selected value"0" >IGST</option>
			<option value="18">18%</option>
			<option value="14">14%</option>
			<option value="12">12%</option>
		</select>
	</div>
    <div class="col-sm-2" ><input type="text" value="0.00" name="igst_add" id="igst_add" class=" form-control col-md-3 column" readonly></div>
 </div>
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Round Of Value: </label>
      <div class="col-md-7">
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Grand Total(Rs.): </label>
      <div class="col-md-7">
...
var srno=0;
   ...
   $( "#clone_items_desc" ).append( '<tr style="background-color:white;">'+'<td class="tda">'+
         '<input type="text" data-index="'+count_row+'" data-error="Enter Item Name" readonly required="required" name="item_name[]" value="'+document.getElementById('item_qty').options[document.getElementById('item_qty').selectedIndex].text+'" class="form-control" >'+
       '</td>'+
     '<td class="tda">'+
...
function remove_fun(a){
  ...
  var r_tot=this.value;
     //alert(this.value)
  var sb_tot=parseFloat(s_tot) - parseInt(r_tot);
  ...
  document.getElementById("grand_total").value = grt;
  }
