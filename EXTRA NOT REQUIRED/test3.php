...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2"></div>
    ...
    <div class="col-md-7">
    <input type="text" data-error="" required="" value="" name="order_no" class="form-control" placeholder="Enter order no">
    <div class="help-block with-errors"></div> 
    </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
    <div class="form-group">
      ...
      <div class="col-md-7">
        <input type="date" data-error="" required="" value="" name="order_date" class="form-control " placeholder=" Enter order date">
        <div class="help-block with-errors"></div> 
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-sm-2 control-label"><b> Transportation Mode: </b></div>
...
<div class="row">
  ...
  <div class="col-sm-2 control-label"><b> LR NO: </b></div>
		<div class=" col-lg-2 form-group">
  ...
  <div class="col-xs-9 col-sm-8 col-md-8 col-lg-8">
    <div class="form-group">
      <label class="col-md-8 control-label">Transportation charge: <i class="fa fa-rupee"></i></label>
      <div class="col-md-4">
...
<div class="row">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      <label class="col-md-5 control-label">Grand Total(Rs.): <i class="fa fa-rupee"></i></label>
      <div class="col-md-7">
