                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card-box">
                                 ...
                                 <h4 class="header-title m-t-0 m-b-30">Customer List</h4>
                                    ...
                                    <div class="row">
                                     <div class="col-sm-12">
                                        <div align="right" style="padding-right:50px;"><a href="custom.php"><button type="button" class="btn btn-success"><font size="3"><i class="fa fa-plus" >  ADD NEW</i></font>  </button></a></div>
                                <div class="card-box table-responsive">
                                     <table class="table table-bordered table-striped paginate" align="center">
                                        ...
                                        <?php 
                                             $sr_no=1;
                                             $retrive_query=mysqli_query($conn, "select * from customer ORDER BY id DESC") or die(mysqli_error());
                                        ...
                                        ?>
                                            ...
                                            <tr>
												...
												<td><a href="customer_view.php?C_id=<?php echo $row['id'] ?>" class="btn btn-primary text-orange" target="" class="on-default remove-row"><i class="fa fa-eye" > View</i></a></td>
                                            </tr>
                                         <?php } ?>
                                        </tbody>
                                    </table>
