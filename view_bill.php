...
<a href="view_bill.php?q_id=<?php echo $nextid; ?>">Next</a>-->
	...
	<table align="center"  style="page-break-before: always;" class=>
		<tr>
				...
				<td colspan="26" align="center" height="10"> <font size="2"><b><u>TAX INVOICE CUM CHALLAN	</u></b></font></td>
...
<thead>		
	...
	<tr >
			<th colspan="30" valign="bottam"><font size="6"><b>SARAL ELECTRICALS</b></font></th>
...
<tbody>
		...
		<tr>
				...
				<td colspan="30" align="center"><font size=""><b>GSTIN: 26AANFS4221Q1ZN </b></font></td>
...
<p align="center"><a href="invoice_print.php?id=<?php echo $row['quot_id'] ?>" class="btn btn-danger text-orange" target="_blank" class="on-default remove-row" align="center"><font size="8"><i class="fa fa-print" > Print</i></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="quot_list.php?id=<?php echo $row['quot_id'] ?>" class="btn btn-danger text-orange" target="" class="on-default remove-row" align="center"><font size="8"><i class="fa-back" > Cancel</i></font></a></p>
